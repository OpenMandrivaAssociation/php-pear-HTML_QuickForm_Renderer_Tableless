...
%define		_status		beta
%define		_pearname	%{_class}_%{_subclass}_Renderer_Tableless
...
install %{_pearname}-%{version}/HTML/QuickForm/Renderer/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Renderer/
...
%doc %{_pearname}-%{version}/docs/*  %{_pearname}-%{version}/data/*
